...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/12/05 12:49:45 by vdoroshy          #+#    #+#             */
/*   Updated: 2016/12/05 12:51:06 by vdoroshy         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int uf_test_tolower(void) {
    ...
    i = -300;
    while (i < 300) {
        if (tolower(i) != ft_tolower(i)) D_ERROR
            i = i + 1;
    }
    return (1);
}
...
int uf_test_toupper(void) {
    ...
    i = -300;
    while (i < 300) {
        if (toupper(i) != ft_toupper(i)) D_ERROR
            i = i + 1;
    }
    return (1);
}
...
int uf_test_isprint(void) {
    ...
    i = -300;
    while (i < 300) {
        if (isprint(i) != ft_isprint(i)) D_ERROR
            i = i + 1;
    }
    return (1);
}
...
int uf_test_isascii(void) {
    ...
    i = -300;
    while (i < 300) {
        if (isascii(i) != ft_isascii(i)) D_ERROR
            i = i + 1;
    }
    return (1);
}
...
int uf_test_isalnum(void) {
    ...
    i = -300;
    while (i < 300) {
        if (isalnum(i) != ft_isalnum(i)) D_ERROR
            i = i + 1;
    }
    return (1);
}
...
int uf_test_isdigit(void) {
    ...
    i = -300;
    while (i < 300) {
        if (isdigit(i) != ft_isdigit(i)) D_ERROR
            i = i + 1;
    }
    return (1);
}
...
int uf_test_isalpha(void) {
    ...
    i = -300;
    while (i < 300) {
        if (isalpha(i) != ft_isalpha(i)) D_ERROR
            i = i + 1;
    }
    return (1);
}
...
int uf_test_atoi(void) {
    ...
    char str[12] = {0};
    if (atoi("\n\v\t\r\f -123") != ft_atoi("\n\v\t\r\f -123")) D_ERROR
        if (atoi("12-3") != ft_atoi("12-3")) D_ERROR
            if (atoi("-+123") != ft_atoi("-+123")) D_ERROR
                if (atoi("a123") != ft_atoi("a123")) D_ERROR
                    if (atoi("123a") != ft_atoi("123a")) D_ERROR
                        if (atoi("123") != ft_atoi("123")) D_ERROR
                            if (atoi("-123") != ft_atoi("-123")) D_ERROR
                                if (atoi("+123") != ft_atoi("+123")) D_ERROR
                                    if (atoi(" - 123") != ft_atoi(" - 123")) D_ERROR
                                        if (atoi("\t -123") != ft_atoi("\t -123")) D_ERROR
                                            if (atoi("-2147483648") != ft_atoi("-2147483648")) D_ERROR
                                                if (atoi("2147483647") != ft_atoi("2147483647")) D_ERROR
                                                    if (atoi("") != ft_atoi("")) D_ERROR
                                                        i = 0;
    while (i < RANDT) {
        j = 0;
        while (j < 11) {
        ...
        str[11] = 0;
        if (atoi(str) != ft_atoi(str)) D_ERROR
            i++;
    }
    return (1);
}
...
#ifdef __clang__
    if (strncmp("abc", "abc", 2) != a) D_ERROR;
#endif
#ifndef __clang__
    if (a)
        D_ERROR;
...
#ifdef __clang__
    if (strncmp("cba", "abc", 2) != a) D_ERROR;
#endif
#ifndef __clang__
    if (!a)
        D_ERROR;
...
#ifdef __clang__
    if (strncmp("abc", "cba", 2) != a) D_ERROR;
#endif
#ifndef __clang__
    if (!a)
        D_ERROR;
...
int uf_test_strcmp(void) {
    ...
    a = ft_strcmp("abc", "cba");
#ifdef __clang__
    if (a != strcmp("abc", "cba")) D_ERROR;
#endif
#ifndef __clang__
    if (!a)
        D_ERROR;
#endif
    if (ft_strcmp("", "") != strcmp("", "")) D_ERROR;
    return (1);
}
...
int uf_test_strnstr(void) {
    ...
    if (strnstr(str, "Hello", 6) != ft_strnstr(str, "Hello", 6)) D_ERROR;
    if (strnstr(str, "Hello", 3) != ft_strnstr(str, "Hello", 3)) D_ERROR;
    if (strnstr(str, "les", 1) != ft_strnstr(str, "les", 1)) D_ERROR;
    if (strnstr(str, "gen", 2) != ft_strnstr(str, "gen", 2)) D_ERROR;
    if (strnstr(str, "w", 0) != ft_strnstr(str, "w", 0)) D_ERROR;
    if (strnstr(str, "", 3) != ft_strnstr(str, "", 3)) D_ERROR;
    return (1);
}
...
int uf_test_strstr(void) {
    char *str = "Hello les genw";
    if (strstr(str, "Hello") != ft_strstr(str, "Hello")) D_ERROR;
    if (strstr(str, "les") != ft_strstr(str, "les")) D_ERROR;
    if (strstr(str, "gen") != ft_strstr(str, "gen")) D_ERROR;
    if (strstr(str, "w") != ft_strstr(str, "w")) D_ERROR;
    if (strstr(str, "") != ft_strstr(str, "")) D_ERROR;
    if (strstr("", "") != ft_strstr("", "")) D_ERROR;
    return (1);
}
...
int uf_test_strchr(void) {
    char str[] = "Hello je tesx";
    if (strchr(str, 'H') != ft_strchr(str, 'H')) D_ERROR
        if (strchr(str, 'j') != ft_strchr(str, 'j')) D_ERROR
            if (strchr(str, 'x') != ft_strchr(str, 'x')) D_ERROR
                if (strchr(str, 'y') != ft_strchr(str, 'y')) D_ERROR
                    if (strchr(str, 0) != ft_strchr(str, 0)) D_ERROR
                        return (1);
}
...
int uf_test_strlcat(void) {
    ...
    char dest2[50] = {0};
    size_t i, j, k;
    if (strlcat(dest, "Hello ", 4) != ft_strlcat(dest2, "Hello ", 4)) D_ERROR
        memset(dest, 0, sizeof(dest));
    memset(dest2, 0, sizeof(dest));
    j = strlcat(dest, "Hello ", 4);
    k = ft_strlcat(dest2, "Hello ", 4);
    if (strcmp(dest, dest2) != 0 || j != k) D_ERROR
...
int uf_test_strncat(void) {
    char dest[50] = {0};
    char dest2[50] = {0};
    if (strncat(dest, "hello ", 2) != ft_strncat(dest, "hello ", 2)) D_ERROR
        memset(dest, 0, sizeof(dest));
    strncat(dest, "Hello ", 4);
    ft_strncat(dest2, "Hello ", 4);
    if (strcmp(dest, dest2) != 0) D_ERROR
...
int uf_test_strcat(void) {
    char dest[50] = {0};
    char dest2[50] = {0};
    if (strcat(dest, "hello ") != ft_strcat(dest, "hello ")) D_ERROR
        memset(dest, 0, sizeof(dest));
    strcat(dest, "Hello ");
...
int uf_test_strncpy(void) {
    ...
    while (k < 21) {
        ...
        while (i < RANDT) {
            ...
            ctab2[20] = 0;
            ctab3[20] = 0;
            if (strncpy(ctab2, ctab, k) != ctab2 || ft_strncpy(ctab3, ctab, k) != ctab3) D_ERROR
                if (strcmp(ctab2, ctab3)) D_ERROR
                    ++i;
        }
        k++;
    }
...
int uf_test_strcpy(void) {
    ...
    while (k <= sizeof(ctab)) {
        ...
        while (i < RANDT) {
            ...
            ctab[10] = 0;
            if (strcpy(ctab2, ctab) != ctab2 || ft_strcpy(ctab3, ctab) != ctab3) D_ERROR
                if (strcmp(ctab2, ctab3)) D_ERROR
                    ++i;
        }
        k++;
    }
    if (strcpy(dest, "Hello foo") != ft_strcpy(dest, "Hello foo")) D_ERROR
...
int uf_test_strlen(void) {
    if (strlen("") != ft_strlen("")) D_ERROR
        if (strlen("abc") != ft_strlen("abc")) D_ERROR
            if (strlen("a") != ft_strlen("a")) D_ERROR
                return (1);
}
...
int uf_test_memmove(void) {
    ...
    while (i < RANDT) {
        ...
        if (strcmp(memmove(str + 10, str + 5, 10), ft_memmove(str2 + 10, str2 + 5, 10)) != 0) D_ERROR
            if (strcmp(memmove(str3 + 5, str3 + 10, 10), ft_memmove(str4 + 5, str4 + 10, 10)) != 0) D_ERROR
                if (strcmp(memmove(s1, s2, 2), ft_memmove(t1, t2, 2)) != 0) D_ERROR
                    if (strcmp(memmove(s1, s1 + 25, 30), ft_memmove(t1, t1 + 25, 30)) != 0) D_ERROR
                        if (strcmp(memmove(s1 + 30, s1, 40), ft_memmove(t1 + 30, t1, 40)) != 0) D_ERROR
                            ++i;
    }
    return (1);
}
...
int uf_test_memchr(void) {
    ...
    while (i < 300) {
        ...
        if (memchr(ctab, i, sizeof(ctab)) != ft_memchr(ctab, i, sizeof(ctab))) D_ERROR
            if (memchr(itab, i, sizeof(itab)) != ft_memchr(itab, i, sizeof(itab))) D_ERROR
                if (memchr(ltab, i, sizeof(ltab)) != ft_memchr(ltab, i, sizeof(ltab))) D_ERROR
                    ++i;
    }
    return (1);
}
...
int uf_test_memcmp(void) {
    ...
    size_t i, j;
#ifdef __clang__
    if (memcmp(NULL, NULL, 0) != ft_memcmp(NULL, NULL, 0)) D_ERROR
#endif
        i = 0;
    while (i < 11) {
        j = 0;
...
int uf_test_memccpy(void) {
    ...
    while (k <= sizeof(ltab)) {
        ...
        while (i < RANDT) {
            ...
            //printf("%s - %s\n", ctab2, ctab3);
            if ((memcmp(ctab2, ctab3, sizeof(ctab)) != 0 || (temp != temp2))) D_ERROR
            ...
            if ((memcmp(itab2, itab3, sizeof(itab)) != 0 || (temp != temp2))) D_ERROR
            ...
            if ((memcmp(ltab2, ltab3, sizeof(ltab)) != 0 || (temp != temp2))) D_ERROR
                ++i;
        }
        ++k;
    }
...
int uf_test_memcpy(void) {
    ...
    while (k <= sizeof(ltab)) {
        ...
        while (i < RANDT) {
            ...
            if ((memcmp(itab2, itab3, sizeof(itab)) != 0 || (temp2 != itab3))) D_ERROR
                if (memcmp(ctab2, ctab3, sizeof(ctab)) != 0 || temp != ctab3) D_ERROR
                    if (memcmp(ltab2, ltab3, sizeof(ltab)) != 0 || (temp3 != ltab3)) D_ERROR
                        ++i;
        }
        ++k;
    }
...
int uf_test_bzero(void) {
    ...
    while (i < 11) {
        ...
        bzero(ctab2, i);
        ft_bzero(ctab, i);
        if (memcmp(ctab, ctab2, sizeof(ctab)) != 0) D_ERROR
            bzero(itab2, i);
        ft_bzero(itab, i);
        if (memcmp(itab, itab2, sizeof(itab)) != 0) D_ERROR
            bzero(ltab2, i);
        ft_bzero(ltab, i);
        if (memcmp(ltab, ltab2, sizeof(ltab)) != 0) D_ERROR
            ++i;
    }
    return (1);
}
